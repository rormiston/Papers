...
def get_run_params(ini_file, section):
    ...
    if section == 'Data':
        ...
        run_params['load_model'] = settings.getboolean(section, 'load_model')
        ...
        run_params['model_dir'] = settings.get(section, 'model_dir')
        ...
        run_params['save_model'] = settings.getboolean(section, 'save_model')
